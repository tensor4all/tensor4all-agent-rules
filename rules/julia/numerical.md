...
- Numerical examples and tests assert meaningful values, residuals, or
  structural invariants, not only shape, non-emptiness, finiteness, or
  successful execution (unless that property is under test).
...
- Julia bindings preserve Rust/C API semantics for layout, ownership, errors,
  and index identity.
